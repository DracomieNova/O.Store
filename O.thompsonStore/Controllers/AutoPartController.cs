...
namespace O.thompsonStore.Controllers
{
    ...
    public class AutoPartController : ControllerBase
    {
        ...
        private readonly OstoreDbContext _context;

        public AutoPartController(OstoreDbContext context)
        {
            _context = context;
        ...
        [HttpPost]
        public IActionResult Postinfo(MainPoint model)
        {
            try
            {
                _context.Add(model);
        ...
        [HttpPut]
        public IActionResult Putinfo(MainPoint model)
        {
